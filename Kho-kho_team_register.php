...
<form class="form-horizontal" action="Kho-kho_team_code.php" method="POST">
	<h1>Kho-kho Team Registration</h1>
  ...
  <div class="form-group">
   ...
   <div class="form-group">
    <label class="control-label col-sm-2" for="firstname">11th Plyer Name:</label>
    <div class="col-sm-6">
      <input type="text" name="elename" class="form-control" id="elename" placeholder="Enter 11th Player Name" required>
    </div>
  </div>
  <div class="form-group">
    <label class="control-label col-sm-2" for="firstname">11th Plyer Enroll No:</label>
    <div class="col-sm-6">
      <input type="num" name="eleen" class="form-control" id="eleen" placeholder="Enter 11th Player Enrollment No" pattern="[0-9]{12}" title="Not a proper format Enrollment" required>
    </div>
  </div>
