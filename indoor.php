...
<form class="form-horizontal" action="indoor_code.php" method="POST">
	<h1>Indoor Games Registration</h1>
  ...
  <div class="form-group">
    ...
    <div class="col-sm-6">
      <label class="radio-inline"><input type="radio" name="game" value="Carrom" required>Carrom</label><br>
    <label class="radio-inline"><input type="radio" name="game" value="Chess" required>Chess</label><br>
    <label class="radio-inline"><input type="radio" name="game" value="Table Tennis" required>Table Tennis</label><br>
    <label class="radio-inline"><input type="radio" name="game" value="Badmintion" required>Badmintion</label>
    </div>
  </div>
