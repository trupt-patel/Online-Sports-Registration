...
<form class="form-horizontal" action="outdoor_code.php" method="POST">
	<h1>Outdoor Games Registration</h1>
  ...
  <div class="form-group">
    ...
    <div class="col-sm-6">
      <label class="radio-inline"><input type="radio" name="game" value="100 Meter" required>100 Meter</label><br>
    <label class="radio-inline"><input type="radio" name="game" value="200 Meter" required>200 Meter</label><br>
    <label class="radio-inline"><input type="radio" name="game" value="Long Jump" required>Long Jump</label><br>
    <label class="radio-inline"><input type="radio" name="game" value="High Jump" required>High Jump</label>
    </div>
  </div>
